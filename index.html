...
// Send notification once per event
function notify(msg){
...
function buildEvent(index, type, label){
  ...
  return `
    <div class="section">
      ...
      <input type="datetime-local" value="${formatInputDate(last)}" onchange="setTime(${index}, 'last${type}', this.value)">
